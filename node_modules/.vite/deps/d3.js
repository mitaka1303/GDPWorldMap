...
Path.prototype = path.prototype = {
  ...
  arc: function(x4, y4, r, a0, a1, ccw) {
    ...
    var dx = r * Math.cos(a0), dy = r * Math.sin(a0), x0 = x4 + dx, y0 = y4 + dy, cw = 1 ^ ccw, da2 = ccw ? a0 - a1 : a1 - a0;
    if (r < 0)
      throw new Error("negative radius: " + r);
    if (this._x1 === null) {
      this._ += "M" + x0 + "," + y0;
  ...
  _init() {
    ...
    for (let i = 0, j = 0, n = triangles.length, x4, y4; i < n; i += 3, j += 2) {
      ...
      if (Math.abs(ab4) < 1e-9) {
        ...
        a4 *= Math.sign((points[r] - x12) * ey - (points[r + 1] - y12) * ex);
        x4 = (x12 + x32) / 2 - a4 * ey;
        y4 = (y12 + y32) / 2 + a4 * ex;
      } else {
        const d = 1 / ab4;
  ...
  function arc() {
    ...
    if (!(r1 > epsilon7))
      ...
      if (rc > epsilon7) {
        ...
        if (da2 < pi4 && (oc = intersect(x01, y01, x00, y00, x11, y11, x10, y10))) {
